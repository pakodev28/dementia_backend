...
from demencia_relatives_test.models import Answer, DemeniaTestCaseAlt, DementiaTestCase, ResultAnswer
...
class DementiaTestCaseAdmin(admin.ModelAdmin):
    ...
    def download_csv(self, request, queryset):
        ...
        answers_qty = 26  # кол-во вопросов в тесте
...
class DementiaTestCaseAltAdmin(DementiaTestCaseAdmin):
    ...
    @admin.display(description="Ответ №26 (оценка)")
    def answer_26(self, obj):
        return self.get_answer(obj, 26)

    @admin.display(description="Итоговая оценка")
    def total_score(self, obj):
        return self.get_answer(obj, 27)
